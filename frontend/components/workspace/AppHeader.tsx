...
const dashboardRoute = { href: '/app', key: 'dashboard' } as const;
const chatRoute = { href: '/app/chat', key: 'chat' } as const;
const dashboardRoutes = [dashboardRoute] as const;
const fullRoutes = [dashboardRoute, chatRoute] as const;
...
export function AppHeader({
  ...
  const routes = chatEnabled ? fullRoutes : dashboardRoutes;
